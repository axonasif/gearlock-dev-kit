...
NAME="Mesa3D-Driver" #Package/Extension Name
...
VERSION="1X.x.x" #Specify the Version of this package/extension
...
GEN_UNINS="no" #(Deafult - no) If you want GearLock to generate a uninstallation script itself
